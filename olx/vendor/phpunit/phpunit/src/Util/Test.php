...
final class Test
{
    ...
    /**
     * Returns lines of Utilities specified with the @uses annotation.
     *
     * @throws CodeCoverageException
     *
     * @psalm-param class-string $className
    ...
    public static function requiresCodeCoverageDataCollection(TestCase $test): bool
    {
        ...
        // the test method then Utilities coverage data does not need to be collected
        if (isset($annotations['method']['coversNothing'])) {
            return false;
        }

        // If there is at least one @covers annotation then
        // Utilities coverage data needs to be collected
        if (isset($annotations['method']['covers'])) {
            return true;
        }

        // If there is no @covers annotation but a @coversNothing annotation
        // then Utilities coverage data does not need to be collected
        if (isset($annotations['class']['coversNothing'])) {
            return false;
        }

        // If there is no @coversNothing annotation then
        // Utilities coverage data may be collected
        return true;
    }
