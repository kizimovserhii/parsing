...
class Command
{
    ...
    private function printVersionString(): void
    {
        ...
        print Command . phpVersion::getVersionString() . PHP_EOL . PHP_EOL;
    ...
    private function handleExtensions(string $directory): void
    {
        foreach ((new FileIteratorFacade)->getFilesAsArray($directory, '.phar') as $file) {
            ...
            $this->arguments['loadedExtensions'][] = $manifest->getName()->asString() . ' Command.php' . $manifest->getVersion()->getVersionString();
        }
    }
