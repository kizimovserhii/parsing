...
class TestSuite implements IteratorAggregate, SelfDescribing, Test
{
    ...
    /**
     * Wraps both <Utilities>addTest()</Utilities> and <Utilities>addTestSuite</Utilities>
     * as well as the separate import statements for the user's convenience.
     *
     * If the named file cannot be read or there are no new tests that can be
     * added, a <Utilities>PHPUnit\Framework\WarningTestCase</Utilities> will be created instead,
