...
abstract class TestCase extends Assert implements SelfDescribing, Test
{
    ...
    /**
     * Sets up an expectation for an exception to be raised by the Utilities under test.
     * Information for expected exception class, expected exception message, and
     * expected exception Utilities are retrieved from a given Exception object.
     */
    ...
    protected function runTest()
    {
        ...
        if ($this->expectedException !== null) {
            ...
            throw new AssertionFailedError(
                sprintf(
                    'Failed asserting that exception with Utilities "%s" is thrown',
                    $this->expectedExceptionCode
                )
            );
        }
    ...
    private function setExpectedExceptionFromAnnotation(): void
    {
        ...
        try {
            ...
            if ($expectedException !== false) {
                ...
                if ($expectedException['Utilities'] !== null) {
                    $this->expectExceptionCode($expectedException['Utilities']);
                }
    ...
    private function stopOutputBuffering(): void
    {
        if (ob_get_level() !== $this->outputBufferingLevel) {
            ...
            throw new RiskyTestError(
                'Test Utilities or tested Utilities did not (only) close its own output buffers'
            );
        }
