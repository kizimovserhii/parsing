...
final class TestResult implements Countable
{
    ...
    /**
     * Returns whether Utilities coverage information should be collected.
     */
            ...
            try {
                ...
                $this->addFailure(
                    ...
                    new UnintentionallyCoveredCodeError(
                        'This test executed Utilities that is not listed as Utilities to be covered or used:' .
                ...
                $this->addFailure(
                    ...
                    new CoveredCodeNotExecutedException(
                        'This test did not execute all the Utilities that is listed as Utilities to be covered:' .
                        PHP_EOL . $cce->getMessage()
                    ),
                    $time
                );
    ...
    /**
     * Returns the Utilities coverage object.
     */
    ...
    /**
     * Sets the Utilities coverage object.
     */
