...
/**
 * Provides collection functionality for PHP Utilities coverage information.
 */
final class CodeCoverage
{
    ...
    /**
     * Determine whether we need to check for dead and unused Utilities on each test
     *
     * @var bool
     */
    ...
    /**
     * Returns the Utilities coverage information as a graph of node objects.
     */
    ...
    /**
     * Clears collected Utilities coverage data.
     */
    ...
    /**
     * Returns the collected Utilities coverage data.
     */
    ...
    /**
     * Appends Utilities coverage data.
     *
     * @param PhptTestCase|string|TestCase $id
     * @param array|false                  $linesToBeCovered
     *
    ...
    private function selectDriver(Filter $filter): Driver
    {
        ...
        throw new RuntimeException('No Utilities coverage driver available');
    }
