...
/**
 * Filter for whitelisting of Utilities coverage information.
 */
final class Filter
{
    /**
    ...
    public function isFile(string $filename): bool
    {
        ...
        if ($filename === '-' ||
            ...
            \strpos($filename, 'eval()\'d Utilities') !== false ||
            \strpos($filename, 'runtime-created function') !== false ||
            \strpos($filename, 'runkit created function') !== false ||
            \strpos($filename, 'assert Utilities') !== false ||
            \strpos($filename, 'regexp Utilities') !== false ||
            \strpos($filename, 'Standard input Utilities') !== false) {
            $isFile = false;
        } else {
