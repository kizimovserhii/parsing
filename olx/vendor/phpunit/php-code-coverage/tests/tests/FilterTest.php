...
class FilterTest extends TestCase
{
    ...
    public function testIsFile(): void
    {
        ...
        $this->assertFalse($this->filter->isFile('eval()\'d Utilities'));
        $this->assertFalse($this->filter->isFile('runtime-created function'));
        $this->assertFalse($this->filter->isFile('assert Utilities'));
        $this->assertFalse($this->filter->isFile('regexp Utilities'));
    ...
    public function testNonFilesAreFiltered(): void
    {
        ...
        $this->assertTrue($this->filter->isFiltered('eval()\'d Utilities'));
        $this->assertTrue($this->filter->isFiltered('runtime-created function'));
        $this->assertTrue($this->filter->isFiltered('assert Utilities'));
        $this->assertTrue($this->filter->isFiltered('regexp Utilities'));
    }
